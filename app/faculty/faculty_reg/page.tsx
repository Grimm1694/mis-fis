...
//                       )}
//                     </div>
//                       <FormField label="Passing Year" stepsReference={`educationSchema.${index}.PassingYear`} type="number" />
//                     {/* Pass Class Dropdown */}
//                     <div>
//                       <label
//                         htmlFor="passClass"
...
//                           </td>
//                           <td>
//                           {Array.isArray(watch("personalSchema.languagesToSpeak"))
...
//                           </td>
//                           <td>
//                           {Array.isArray(watch("personalSchema.languagesToRead"))
...
//                           </td>
//                           <td>
//                           {Array.isArray(watch("personalSchema.languagesToWrite"))
...
//                             alert("Error submitting form. Server returned an error.");
//                         }
//                     } catch (error) {
